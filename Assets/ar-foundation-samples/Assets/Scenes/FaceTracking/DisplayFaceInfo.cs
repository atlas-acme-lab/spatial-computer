        ...
        void OnBeforeRender()
        {
            ...
            foreach (var face in m_FaceManager.trackables)
            {
                if (face.trackingState == TrackingState.Tracking)
                {
                    ...
                    m_FaceControlledObject.transform.position = face.transform.position;

                    //m_FaceControlledObject.transform.LookAt(m_CameraManager.gameObject.transform.position + m_CameraManager.gameObject.transform.right*0.1f);
